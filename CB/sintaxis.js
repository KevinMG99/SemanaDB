...
var num = 15
let numUno; //no definida(undefined) 
let numDos = null //nula
...
let date = new Date() //toda la fecha
let dd = date.getDate(),  //presenta dia
    mm = date.getMonth() + 1, //presenta mes
    aa = date.getFullYear(), //presenta año
...
console.log("Resultado1 =", numUno)
console.log(`Resultado2 = ${numDos} `) 
...
let colores =["black","red","blue" ]

//objetos con metodo json
const json = {              
    "autos": ["Hyundai","Tucson"],
    "marca": "Hyundai"
};
//objetos en js
const estudiante = {
...
if (numUno==undefined){
    console.log(`La variable si es '${numUno}'`)
}
if (numDos==null){
    console.log(`La variable si es '${numDos}'`)
}
if (num1==0 || num2==0){
...
const Autos=[
    {"Modelo":"Vitesse", "Marca":"Bugatti"},
    {"Modelo":"Tucson", "Marca":"Hyundai"},
    {"Modelo":"Aventador", "Marca":"Lamborgini"}
]
...
console.log("Foreach");
Autos.forEach(auto => console.log(auto.Modelo))
//map
const cars=Autos.map(car => car.Modelo)
console.log("Map", cars);
//filter
const car=Autos.filter(car => car.Modelo != "Vitesse")
console.log("Filter", car);
//find
const oneCar = Autos.find(car => car.Modelo === "Vitesse")
